...
class MiT(nn.Module):
    def __init__(self, *, channels, dims, heads, ff_expansion, reduction_ratio, num_layers, pad_stride):
        super().__init__()
        stage_kernel_stride_pad = ((7, pad_stride, 3), (3, 2, 1), (3, 2, 1), (3, 2, 1))  # 743->723
...
class Segformer(nn.Module):
    def __init__(
            self,
            *,
            dims=(32, 64, 160, 256),  # (32, 64, 160, 256) -> (24, 48, 120, 192)
            heads=(1, 2, 5, 8),
            ff_expansion=(8, 8, 4, 4),
            reduction_ratio=(8, 4, 2, 1),
            num_layers=2,
            channels=1,
            decoder_dim=256,  # 256 -> 192
            num_classes=2,
            pad_stride=4):
        super().__init__()
